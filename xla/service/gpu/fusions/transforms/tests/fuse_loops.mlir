...
" domain:"
"   d0 in [0, 98303]">
func.func @fuse_identical_independent_loops(%arg0: tensor<8192x4xf64>, %arg1: tensor<98304x4xf64>, %arg2: tensor<98304x4xf64>) -> tensor<98304x4xf64> {
  %tid = gpu.thread_id  x {xla.range = [0 : index, 127 : index]}
  %bid = gpu.block_id  x {xla.range = [0 : index, 1023 : index]}
  %cst_2 = arith.constant 0.50000000000000089 : f64
  %cst = arith.constant 0 : index
  %xla_loop = xla_gpu.loop (%tid, %bid)[%i, %j] -> (%ra, %rb) in #indexing_map iter_args(%iter = %arg1) -> (tensor<98304x4xf64>) {
  ...
  %xla_loop_1 = xla_gpu.loop (%tid, %bid)[%i, %j] -> (%ra, %rb) in #indexing_map iter_args(%iter = %arg2) -> (tensor<98304x4xf64>) {
    %0:2 = xla_gpu.apply_indexing #indexing_map1(%ra)
    %extracted = tensor.extract %arg0[%0#0, %0#1] : tensor<8192x4xf64>
    %inserted = tensor.insert %extracted into %iter[%ra, %rb] : tensor<98304x4xf64>
    xla_gpu.yield %inserted : tensor<98304x4xf64>
  }
...
// CHECK-SAME: (%[[ARG0:.*]]: tensor<8192x4xf64>, %[[ARG1:.*]]: tensor<98304x4xf64>, %[[ARG2:.*]]: tensor<98304x4xf64>)
...
" domain:"
"   d0 in [0, 98303]">
func.func @do_not_fuse_dependent_loops(%arg0: tensor<8192x4xf64>, %arg1: tensor<98304x4xf64>, %arg2: tensor<98304x4xf64>) -> tensor<98304x4xf64> {
  %tid = gpu.thread_id  x {xla.range = [0 : index, 127 : index]}
  %bid = gpu.block_id  x {xla.range = [0 : index, 1023 : index]}
  %cst_2 = arith.constant 0.50000000000000089 : f64
  %cst = arith.constant 0 : index
  ...
  %dependency = tensor.insert %cst_2 into %xla_loop[%cst, %cst] : tensor<98304x4xf64>
  %xla_loop_1 = xla_gpu.loop (%tid, %bid)[%i, %j] -> (%ra, %rb) in #indexing_map iter_args(%iter = %dependency) -> (tensor<98304x4xf64>) {
    %0:2 = xla_gpu.apply_indexing #indexing_map1(%ra)
    %extracted = tensor.extract %arg0[%0#0, %0#1] : tensor<8192x4xf64>
    %inserted = tensor.insert %extracted into %iter[%ra, %rb] : tensor<98304x4xf64>
    xla_gpu.yield %inserted : tensor<98304x4xf64>
