...
module attributes {"triton_gpu.num-warps" = 4 : i32} {
  tt.func @sparse_dot_loop(%lb : index, %ub : index, %step : index,
    ...
    %loop:4 = scf.for %iv = %lb to %ub step %step iter_args(%a_ptr = %a_ptr_init, %b_ptr = %b_ptr_init, %c = %c_init, %meta_ptr = %meta_ptr_init)
      ...
      // CHECK: xla_triton_ext.sparse_dot
      ...
      %d = xla_triton_ext.sparse_dot %a, %b, %c, %meta : tensor<128x32xf16, #dot_operand_a> meta tensor<128x4xi16, #dot_meta_enc> * tensor<64x128xf16, #dot_operand_b> -> tensor<128x128xf32, #mma>
