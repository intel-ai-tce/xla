...
module attributes {"triton_gpu.num-warps" = 4 : i32} {
  ...
  tt.func @sparse_dot_to_llvm_hopper(%A_alloc: !tt.memdesc<64x32xf16, #shared, #triton_gpu.shared_memory>,
    ...
    %D = xla_triton_ext.sparse_dot %A_alloc, %B_alloc, %acc, %meta_reg : !tt.memdesc<64x32xf16, #shared, #triton_gpu.shared_memory> meta tensor<64x4xi16, #dot_meta_enc> * !tt.memdesc<64x64xf16, #shared, #triton_gpu.shared_memory> -> tensor<64x64xf32, #mma>
    tt.return
  }
}
